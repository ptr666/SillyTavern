 ...
 */
async function saveAuthData(access, refresh, expires, enterpriseUrl) {
...
async function refreshTokenIfNeeded(authData, auth) {
    ...
    refreshInProgress = (async () => {
        try {
            ...
            // Save the new tokens
            await saveAuthData(newTokens.access_token, newTokens.refresh_token, newExpiry, instanceUrl);
