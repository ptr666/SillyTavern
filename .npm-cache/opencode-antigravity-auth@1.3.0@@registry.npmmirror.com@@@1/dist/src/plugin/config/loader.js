...
import { AccountSelectionStrategySchema, AntigravityConfigSchema, DEFAULT_CONFIG } from "./schema";
...
function applyEnvOverrides(config) {
    ...
    return {
        ...
        pid_offset_enabled: env.OPENCODE_ANTIGRAVITY_PID_OFFSET_ENABLED === "1" ||
        ...
        web_search: {
            default_mode: env.OPENCODE_ANTIGRAVITY_WEB_SEARCH === "auto"
                ? "auto"
                : env.OPENCODE_ANTIGRAVITY_WEB_SEARCH === "off"
                    ? "off"
                    : config.web_search?.default_mode ?? "off",
            grounding_threshold: env.OPENCODE_ANTIGRAVITY_WEB_SEARCH_THRESHOLD
